              ...
              <Box textColor={"gray.500"} p="4" borderRadius="lg">
                ...
                >
                  <Flex alignItems="center" gap="2" textAlign={"center"}>
                    <FaGift size={80} />
                    <Text fontSize="md" textColor="#522C2C">
                      Refer and get 1 month free subscription
                    </Text>
                  </Flex>
                </Box>
              </Box>
              ...
              <Box>
                <Box p="4" mt="8" borderRadius="lg" bg="white">
                  ...
                  <Text mt="2" fontSize="sm" textColor="gray.500">
                    Browse through our courses and find the one that suits you
                  </Text>
                </Box>
                <Grid templateColumns="repeat(3, 1fr)" gap={6} mt="4">
                  {loading
                    ? new Array(6).fill(6).map((el, index) => (
                          ...
                          <GridItem colSpan={1}>
                            <Box borderRadius="lg" boxShadow={"md"} bg="white">
                              ...
                              <Box p="4">
                                ...
                                <Text mt="2" fontSize="sm" textColor="gray.500">
                                  Learn{" "}
                                  {course.title.split("to")[1].length > 10
                                    ? `${course.title
                                        .split("to")[1]
                                        .slice(0, 10)}... `
                                    : course.title.split("to")[1]}{" "}
                                  from scratch
                                </Text>
                                <Text mt="2" fontSize="sm" textColor="gray.500">
                                  Duration:{" "}
