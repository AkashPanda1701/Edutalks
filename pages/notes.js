...
import { Box, Flex, chakra, Grid } from "@chakra-ui/react";
      ...
      >
        ...
        >
          <NotesCard
            ...
            getnow={"Get Now"}
            image={
              "url(https://media.istockphoto.com/id/1413514774/photo/stylized-3d-html-icon-design.jpg?b=1&s=170667a&w=0&k=20&c=OrkPbETxWlQ4FQSfTku07zULRenQ6KnxkGM4nU5H_Kk=)"
            }
          ...
          <NotesCard
            ...
            getnow={"Get Now"}
            image={
              "url(https://media.istockphoto.com/id/1413514596/photo/stylized-3d-css-icon-design.jpg?b=1&s=170667a&w=0&k=20&c=Y2wiMC1eKiraLPz-NZmIhyk-ZJfr_FxUHXZ_3lmmLlg=)"
            }
          ...
          <NotesCard
            ...
            getnow={"Get Now"}
            image={
              "url(https://miro.medium.com/max/800/1*yWUgGAQuiROzilwG_tEU2Q.png)"
            }
          ...
          <NotesCard
            ...
            getnow={"Get Now"}
            image={
              "url(https://cdn.iconscout.com/icon/free/png-256/node-js-3550841-2970426.png)"
            }
          ...
          <NotesCard
            ...
            free={"Free"}
            getnow={"Get Now"}
            image={"url(https://cdn-icons-png.flaticon.com/512/226/226777.png)"}
